...
person_info = ("Fariha", 24, "Chittagong", 175.5)

# Define a dictionary with the tuple as a value
person_dict = {
    "ID": 101,
    "Info": person_info,
    "Occupation": "Student"
...
# Accessing and printing information using the dictionary
print("Person ID:", person_dict["ID"])
print("Person Name:", person_dict["Info"][0])
print("Person Age:", person_dict["Info"][1])
print("Person Location:", person_dict["Info"][2])
print("Person Height:", person_dict["Info"][3])
print("Person Occupation:", person_dict["Student"])
...
# Sort the list of tuples by grades (ascending order)
sorted_grades = sorted(student_grades, key=lambda x: x[1])

# Print the sorted list
print("Sorted list of student names and grades:")
